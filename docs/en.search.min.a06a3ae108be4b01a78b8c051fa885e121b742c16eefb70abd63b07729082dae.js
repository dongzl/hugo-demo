...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/hugo-demo/flexsearch.min.js');loadScript('/hugo-demo/en.search-data.min.53e77b07ecd01eb8d8cce10f31cb0bdfcf4ae52e1803c0bec3e4c8db61b43ff3.js',function(){input.required=false;search();});}
